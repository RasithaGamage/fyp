                            ...
                            <div class="card-body box-profile">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <h3 class="profile-username text-center" id="petNameLbl1">  </h3>
                                ...
                                <ul class="list-group list-group-unbordered mb-3">
                                    <li class="list-group-item">
                                        <b>Age</b> <a class="float-right" id="ageLbl1"></a>
                                    </li>
                                    <li class="list-group-item">
                                     ...
                                     <li class="list-group-item">
                                        <b>Breed</b> <a class="float-right" id="weightLbl1"></a>
                                    </li>
                                    <li class="list-group-item">
                                        <b>Weight</b> <a class="float-right" id="weightLbl1"></a>
                                    </li>
                                </ul>
